...
var TDDConfigSchema = import_zod.z.object({
  ...
  documents: import_zod.z.object({
    ...
    minPrdLines: import_zod.z.number().min(50).default(200),
    /** Minimum lines for technical spec */
    minSpecLines: import_zod.z.number().min(100).default(500),
    /** Minimum lines for test spec */
    minTestLines: import_zod.z.number().min(50).default(300),
    /** Minimum lines for agent spec */
    minAgentSpecLines: import_zod.z.number().min(50).default(100),
    /** Minimum lines for tasks breakdown */
    minTasksLines: import_zod.z.number().min(100).default(500)
  }).default({}),
  // =========================================
  // FEATURE FLAGS
  // =========================================
