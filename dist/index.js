...
var TDDConfigSchema = import_zod.z.object({
  ...
  workflow: import_zod.z.object({
    ...
    tasksDir: import_zod.z.string().default("tasks"),
...
async function loadConfig(projectDir) {
  ...
  const configPaths = [
    (0, import_path.join)(dirPath, "opencode-tdd.json"),
    (0, import_path.join)(dirPath, ".opencode", "opencode-tdd.json"),
    (0, import_path.join)(process.env.HOME || "~", ".config", "opencode", "opencode-tdd.json")
  ];
